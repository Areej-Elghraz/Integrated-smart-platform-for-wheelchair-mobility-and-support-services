                            ...
                            <table border="0" cellspacing="0" cellpadding="0" style="background-color: #F2AD94; border-radius: 8px; margin: 20px auto;">
                                <tr>
                                    <td align="center" style="padding: 20px 40px;">
                                        <p style="font-size: 48px; font-weight: bold; color: #255059; letter-spacing: 5px; margin: 0;"><?php echo e($otpCode); ?></p>
                                    </td>
                                </tr>
                            </table>
...
<?php /**PATH D:\apiCourse\API_Projects\Chairpal\resources\views/emails/otp.blade.php ENDPATH**/ ?>